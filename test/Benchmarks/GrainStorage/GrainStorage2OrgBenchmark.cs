...
{
    public class GrainStorage2OrgBenchmark : IDisposable
    {
        ...
        public GrainStorage2OrgBenchmark(int concurrent, int payloadSize, TimeSpan duration)
        {
        ...
        {
            var persistentGrain = this.host.Client.GetGrain<IPersistentGrain2DifferentPayloadSize>(Guid.NewGuid());
            // activate grain
