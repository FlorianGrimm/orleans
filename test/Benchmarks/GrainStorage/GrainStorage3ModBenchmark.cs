...
{
    public class GrainStorage3ModBenchmark : IDisposable
    {
        ...
        public GrainStorage3ModBenchmark(int concurrent, int payloadSize, TimeSpan duration)
        {
        ...
        {
            Orleans.Storage.AdoNetGrainStorage.HackFlag = true;
